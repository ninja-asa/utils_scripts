...
> 
> `git up` downloads all the remote commits and will perform a "fast-forward" merge - which will fail in case you have uncomitted changes localy.
...
Additionaly, all branches that have been deleted remotely of a given repository shall have its local branch deleted.
